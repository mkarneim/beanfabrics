...
/**
 * The FileInfoRegistry is a helper class that offers OS specific information for {@link File} objects.
 * For instance it provides an {@link Image} object for 
 * a given {@link File} showing the filesystem's file icon of that file.
 * <p>
 * Since there is no convenient support for this functionality in plain SWT this
 * class uses the Swing class {@link JFileChooser}.
 * 
 * For converting a Swing {@link Icon} to an SWT {@link Image} this class uses 
 * the {@link ImageConverter} which is part of this package.
 * 
