...
/**
 * The <code>BnColumnPropertyEditor</code> is a JavaBeans {@link PropertyEditor} for a {@link BnColumn}.
 * 
...
public class BnColumnPropertyEditor implements PropertyEditor {
	...
	private BnColumn scanDef(String text) throws IllegalArgumentException {
		if (text == null || text.trim().length() == 0) {
			return null;
		} else {
