...
public class ColumnListPanel extends JPanel implements View<ColumnListPM>, ModelSubscriber {
	...
	private BnTable getBnTable() {
		if (bnTable == null) {
	       ...
	       new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("this.path"), "Path", 120, false, new org.beanfabrics.Path("this.path.choosePath")    )
	       , new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("this.columnName"), "ColumnName", 100, true    )
	       , new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("this.width"), "Width", 55, true    )
