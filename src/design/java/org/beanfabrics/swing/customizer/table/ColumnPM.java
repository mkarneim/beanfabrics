...
/**
 * The <code>ColumnPM</code> is a presentation model presenting a {@link BnColumn}.
 * 
...
public class ColumnPM extends AbstractPM {
	...
	public BnColumn getBnColumn() {
		BnColumn result = new BnColumn( 
			this.path.getPath(), this.columnName.getText(),
			this.width.getInteger(), this.fixedWidth.getBoolean(),
			this.operationPath.getPath()
		);
		return result;
	}
