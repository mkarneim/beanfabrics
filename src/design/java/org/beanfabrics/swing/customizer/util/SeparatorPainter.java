...
/**
 * The <code>SeparatorPainter</code> is a utility class for painting a horizontal line.
 * 
...
class SeparatorPainter {
	...
	public static void paint(JComponent comp, Graphics g, String text,
		...
		if (fm != null) {
			...
			g.drawLine(w + 3 + xOffset, h + yOffset, comp.getWidth(), h
					+ yOffset);
			g.setColor(Color.white);
			g.drawLine(w + 3 + xOffset, h + yOffset + 1, comp.getWidth(), h
					+ yOffset + 1);
