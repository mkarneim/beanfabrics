	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		try {
			...
			final PropertyDescriptor provider = new PropertyDescriptor("modelProvider",
					beanClass, "getModelProvider", "setModelProvider");
			final PropertyDescriptor path = new PropertyDescriptor("path",
					beanClass, "getPath", "setPath");
			final PropertyDescriptor columns = new PropertyDescriptor(
					"columns", beanClass, "getColumns", "setColumns");
