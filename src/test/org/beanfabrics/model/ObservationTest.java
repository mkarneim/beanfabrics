...
public class ObservationTest {
	...
	static class GroupPM extends AbstractPM {
		@Property ListPM<ContactPM> contacts = new ListPM<ContactPM>();
		@Property ContactPM selectedContact;
		public GroupPM() {
	...
	static class ContactPM extends AbstractPM {
		@Property TextPM firstname = new TextPM();
		@Property TextPM lastname = new TextPM();
		@Property AddressPM address = new AddressPM();
		public ContactPM() {
			PMManager.setup(this);
		}
	}
	static class AddressPM extends AbstractPM {
		@Property TextPM street = new TextPM();
		@Property TextPM city = new TextPM();
		@Property TextPM country;
		public AddressPM() {
			PMManager.setup(this);
		}
	}
