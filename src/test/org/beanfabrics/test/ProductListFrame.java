...
public class ProductListFrame extends JFrame {
	...
	protected BnTable getBnTable() {
		if (bnTable == null) {
	       ...
	       new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("this.name"), "Name", 100, false    )
	       , new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("this.type"), "Type", 80, true    )
	       , new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("this.country"), "Country", 80, true    )
