...
public class ProductListPM extends AbstractPM {
	@Property ListPM<ProductPM> elements = new ListPM<ProductPM>();
	@Property IOperationPM sortByName = new OperationPM();
	@Property IOperationPM sortByType = new OperationPM();
	@Property IOperationPM sortByPrice = new OperationPM();
	@Property IOperationPM sortByCountry = new OperationPM();
