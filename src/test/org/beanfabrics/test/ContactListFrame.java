...
public class ContactListFrame extends JFrame {
	...
	private BnTable getBnTable() {
		if (bnTable == null) {
	       ...
	       new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("this.icon"), "", 25, true    )
	       , new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("lastname"), "Name", 100, false    )
	       , new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("birthday"), "Birthday", 80, true    )
	       , new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("address.street"), "Street", 100, false    )
	       , new org.beanfabrics.swing.table.BnColumn( new org.beanfabrics.Path("this.children"), "Children", 100, false    )
