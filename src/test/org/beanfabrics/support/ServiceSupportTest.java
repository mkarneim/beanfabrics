...
public class ServiceSupportTest {
	...
	public static class TopLevelModel extends AbstractPM {
		@Property LevelOneModel levelOneModel;
		@Property ListPM<RowModel> rows = new ListPM<RowModel>();
	...
	public static class LevelOneModel extends AbstractPM {
		@Property LevelTwoModel levelTwo = new LevelTwoModel();
	...
	public static class LevelTwoModel extends AbstractPM {
		@Property LevelThreeModel levelThree = new LevelThreeModel();
