...
public class ValidationTest {
    ...
    private static class ProductPM extends AbstractPM {
    	public int saved = 0;
    	@Property public final TextPM name = new TextPM();
    	@Property public final IntegerPM volume = new IntegerPM();
    	@Property public final ListPM<PartPM> parts = new ListPM<PartPM>();
    	@Property public final IOperationPM save = new OperationPM();
    	public ProductPM() {
