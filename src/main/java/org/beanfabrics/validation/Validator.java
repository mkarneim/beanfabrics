 ...
 * instances.
 * <pM>
 * It is a composite of validation rules. Rules can be added and removed via the
 * collection interface.
 * <pM>
 * A call to the {@link #validate()} method is delegated to each validation rule
 * in the order they have been added, until the first not-<code>null</code>
 * {@link ValidationState} is returned.
 *
