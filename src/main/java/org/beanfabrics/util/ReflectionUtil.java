...
public class ReflectionUtil {
	...
	/**
     * Returns all declared fields of the given {@link Class} and it's superclasses.
     */
	 ...
	 *            name filtering
	 * @param fieldType the generic type of the returned fields or <code>null</code>
...
//		  }
    ...
    /**
     * Returns all declared members of the given {@link Class} and it's superclasses.
    ...
    /**
     * Returns all declared methods of the given {@link Class} and it's superclasses.
	 ...
	 * @param cls the class of which to search the methods
	 * @param annotationType the annotation type which mark methods to be contained in the
	 *            result
	 */
	...
	/**
	 * Returns a {@link List} of all superclasses and all interfaces of the given baseclass, including the baseclass.
	 * @param baseClass
	 * @return List
	 */
	...
	/**
     * Calls all methods of <code>target</code> that are annotated with the specified <code>annotationType</code>.
     * @param target the <code>Object</code> to call the methods from
     * @param annotationType the type of the annotation marking the methods to call
     */
    ...
    public static void setProperties(Object bean, Properties props) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException, SecurityException, NoSuchMethodException {
    ...
    public static synchronized void setFieldValue( Object owner, Field field, Object value) throws IllegalArgumentException, IllegalAccessException {
    ...
    public static synchronized Object getFieldValue( Object owner, Field f) throws IllegalArgumentException, IllegalAccessException {
    ...
    public static synchronized Object invokeMethod( Object owner, Method m, Object...args) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
    	callCount++;
