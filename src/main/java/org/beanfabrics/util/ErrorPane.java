...
/**
 * The <code>ErrorPane</code> is a panel that shows a message beside an error icon and - when checking the
 * checkbox - the stack trace of a {@link Throwable}.
 *
...
public class ErrorPane extends JPanel {
	 ...
	 *            message to display
	 * @param cause
	 *            <code>Throwable</code> to display the stack trace of
	 */
	 ...
	 *
	 * @param message
	 *            message to display, may be <code>null</code>
	 * @param cause
	 *            <code>Throwable</code> to display the stack trace of, may be
	 *            <code>null</code>
	 */
	 ...
	 *            title of the dialog
	 * @param message
	 *            message to show in the dialog, may be <code>null</code>
	 * @param cause
	 *            Throwable to show the stack trace of in the dialog, may be
	 *            <code>null</code>
	 */
