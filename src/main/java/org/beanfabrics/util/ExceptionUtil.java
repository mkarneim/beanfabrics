...
/**
 * The <code>ExceptionUtil</code> is a singleton that provides access to an {@link IExceptionHandler}
 * which is used by the Beanfabrics framework to handle exceptions.
 *
