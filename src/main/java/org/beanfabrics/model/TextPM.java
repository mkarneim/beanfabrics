...
public class TextPM extends AbstractValuePM implements ITextPM {
	...
	private final ResourceBundle resourceBundle = ResourceBundle.getBundle(TextPM.class.getName() + "ResourceBundle");
	/**
	...
	/**
	 * If set to <code>true</code> this <code>TextPM</code> is only valid if it's text
	 * content is contained in it's options.
	 *
