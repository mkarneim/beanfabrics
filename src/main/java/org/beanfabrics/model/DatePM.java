...
/**
 * The DatePM is a presentation model for {@link Date} objects. The text format is locale
 * dependent but can be changed manually by calling {@link #setFormat(DateFormat)}.
 *
 * @author Max Gensthaler
 * @author Michael Karneim
 */
// TODO (mg) if this is taken: cleanup resource bundles
public class DatePM extends TextPM implements IDatePM {
	...
	private final ResourceBundle resourceBundle = ResourceBundle.getBundle(DatePM.class.getName() + "ResourceBundle");
