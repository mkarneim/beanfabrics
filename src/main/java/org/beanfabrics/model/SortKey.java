...
/**
 * The SortKey describes the sort order for a field accessible by a particular {@link Path} 
...
public class SortKey {
	...
	/**
	 * Creates a new <code>SortKey</code> for the specified {@link Path} with the
	 * specified sort direction.
	 * @param ascending the sort direction
	 * @param sortPath the {@link Path} to the field relative to the element's root
	 */
	...
	/**
	 * Returns <code>true</code> if the sort direction is ascending, <code>false</code> otherwise.
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((sortPath == null) ? 0 : sortPath.hashCode());
		return result;
	}
