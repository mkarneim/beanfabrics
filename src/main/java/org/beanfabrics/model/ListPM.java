...
/**
 * The ListPM is a list of presentation models. Basically it provides methods for adding, removing, accessing and iterating
...
public class ListPM<T extends PresentationModel> extends AbstractPM implements IListPM<T> {
	...
	/**
	 * This list holds all elements of this <code>ListPM</code>. All elements are wrapped
	 * into {@link Entry} objects that hold a {@link Entry#isSelected} flag.
	 * This list is an {@link ArrayList} to ensure quick index-base access.
	 */
...
//			}
	 ...
	 * @param paths one or more Path objects must be specified to define which pM properties
...
//			return maxSelIndex;
		...
		/**
		 * Returns the index of the next selected element AFTER
		 * the given index, or -1 if no element is found.
		 * @param index
		 * @return the index of the next selected element after the given index, or -1 if no element is found.
		 */
...
//						}
	...
	/**
	 * This validation rule defines that this model is invalid whenever a
