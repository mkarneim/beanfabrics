...
/**
 * The Operation is a presentation model that maintains a list of {@link ExecutionMethod}s that will be executed whenever the {@link #execute()}
 * method is invoked.
 *
...
public class OperationPM extends AbstractOperationPM {
	...
	private final ResourceBundle resourceBundle = ResourceBundle.getBundle(OperationPM.class.getName() + "ResourceBundle");
