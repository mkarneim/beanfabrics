...
/**
 * The <code>BnPlainDocument</code> is a {@link PlainDocument} which
 * is a {@link View} on a {@link ITextPM}.
 *
...
public class BnPlainDocument extends PlainDocument implements View<ITextPM> {
	...
	/**
	 * Setting this to <code>true</code> disables the delegation
	 * (to the model) inside the {@link #remove(int, int)} method.
	 */
