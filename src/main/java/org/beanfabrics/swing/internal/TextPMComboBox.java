...
public class TextPMComboBox extends JComboBox implements View<ITextPM> {
	...
	/**
	 * Constructs a new {@link BnComboBoxEditor} for this <code>BnComboBox</code>.
	 * This new <code>BnComboBoxEditor</code> is used for editing the value of
	 * this <code>BnComboBox</code>.
	 *
	...
	protected void paintErrorIcon(Graphics g) {
		if ( this.isEditable()) return; // editable => error icon gets painted by BnComboBoxEditor
	...
	protected class TextEditorComboBoxModel extends AbstractListModel implements ComboBoxModel {
		...
		public int getSize() {
			...
			if ( pModel.getOptions() == null) return 0;
		...
		public void setSelectedItem(Object anItem) {
			if ( anItem == null && this.getSelectedItem() == null) return;
			if ( anItem != null && anItem.equals(this.getSelectedItem())) {
				return;
			}
			pModel.setText( anItem != null
					? anItem.toString()
				    : "");
