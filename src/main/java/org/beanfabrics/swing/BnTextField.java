...
/**
 * The <code>BnTextField</code> is a {@link JTextField} that can subscribe to an {@link ITextPM}.
 * <p>
 * For an example about using BnTextField, please see 
 * <a href="http://www.beanfabrics.org/index.php/BnTextField" target="parent">http://www.beanfabrics.org/index.php/BnTextField</a>
 * </p>
...
public class BnTextField extends TextPMTextField implements ModelSubscriber {
	...
	/**
	 * Constructs a <code>BnTextField</code> and binds it to 
	 * the specified model.
	...
	/**
	 * Constructs a <code>BnTextField</code> and subscribes it 
