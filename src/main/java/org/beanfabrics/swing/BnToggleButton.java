...
/**
 * The <code>BnToggleButton</code> is a {@link JToggleButton} that can subscribe
...
public class BnToggleButton extends BooleanPMToggleButton implements ModelSubscriber {
    ...
    /**
     * Constructs a <code>BnToggleButton</code> and binds it to the specified
     * model.
     * 
    ...
    /**
     * Constructs a <code>BnToggleButton</code> and subscribes it for the model
