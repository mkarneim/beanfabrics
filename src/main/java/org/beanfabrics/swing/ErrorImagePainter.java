...
public class ErrorImagePainter {
	 ...
	 *
	 * @param g
	 *            graphics object to paint to, should be the {@link Graphics} of
	 *            {@link Component} c
	 * @param c
	 *            component to paint the icon for
	 * @param isRightAligned
	 *            <code>true</code> if the text in the {@link Component} c is
	 *            right aligned, else <code>false</code>
	 */
	 ...
	 * @param x
	 *            horizontal position of the top left corner of the error icon
	 *            in {@link Graphics} <code>g</code>
	 * @param y
	 *            vertical position of the top left corner of the error icon in
	 *            {@link Graphics} <code>g</code>
	 * @param hasFocus
	 *            <code>true</code> if the component has the focus of which the
	 *            {@link Graphics} object <code>g</code> is from. If
