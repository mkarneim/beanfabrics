 ...
 *
 * <p>
 * For an example about using BnTable, please see
 * <a href="http://www.beanfabrics.org/index.php/BnTable" target="parent">http://www.beanfabrics.org/index.php/BnTable</a>
 * </p>
 *
...
public class BnTable extends JTable implements View<IListPM<? extends PresentationModel>>, ModelSubscriber {
     ...
     * dependent on the Java version. In Java 5 a {@link Java5SortingTableHeader}
     * is returned. In Java 6 and later the standard {@link JTableHeader} is returned.
     *
