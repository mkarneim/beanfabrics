...
/**
 * The <code>BnMenuItem</code> is a {@link JMenuItem} that can subscribe to an
 * {@link IOperationPM}.
 * 
...
public class BnMenuItem extends OperationPMMenuItem implements ModelSubscriber {
    ...
    /**
     * Constructs a <code>BnMenuItem</code> and binds it to the specified model.
     * 
    ...
    /**
     * Constructs a <code>BnMenuItem</code> and subscribes it for the model at
