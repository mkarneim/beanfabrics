...
/**
 * The <code>BnButton</code> is a {@link JButton} that can subscribe to an {@link IOperationPM}.
 * <p>
 * For an example about using BnButton, please see 
 * <a href="http://www.beanfabrics.org/index.php/BnButton" target="parent">http://www.beanfabrics.org/index.php/BnButton</a>
 * </p>
 * 
...
public class BnButton extends OperationPMButton implements ModelSubscriber {
	...
	/**
	 * Constructs a <code>BnButton</code> and binds it to
	 * the specified model
	...
	/**
	 * Constructs a <code>BnButton</code> and subscribes it 
