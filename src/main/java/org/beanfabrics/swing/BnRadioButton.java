...
/**
 * The <code>BnRadioButton</code> is a {@link JRadioButton} that can subscribe to an {@link IBooleanPM}.
 * 
...
public class BnRadioButton extends BooleanPMRadioButton implements ModelSubscriber {
	...
	/**
	 * Constructs a <code>BnRadioButton</code> and binds it
	...
	/**
	 * Constructs a <code>BnRadioButton</code> and subscribes it 
