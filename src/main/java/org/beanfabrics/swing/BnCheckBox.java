...
/**
 * The <code>BnCheckBox</code> is a {@link JCheckBox} that can subscribe to an {@link IBooleanPM}.
 * 
 * <p>
 * For an example about using BnCheckBox, please see 
 * <a href="http://www.beanfabrics.org/index.php/BnCheckBox" target="parent">http://www.beanfabrics.org/index.php/BnCheckBox</a>
 * </p>
...
public class BnCheckBox extends BooleanPMCheckBox implements ModelSubscriber {
	...
	/**
	 * Constructs a <code>BnCheckBox</code> and binds it to
	 * the specified model.
	...
	/**
	 * Constructs a <code>BnCheckBox</code> and subscribes it 
