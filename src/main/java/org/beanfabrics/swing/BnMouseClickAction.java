...
/**
 * The <code>BnMouseClickAction</code> is a {@link MouseListener} that can subscribe to an {@link IOperationPM}.
 * 
...
public class BnMouseClickAction extends BnAction implements MouseListener {
	...
	/**
	 * Constructs a <code>BnMouseClickAction</code> and binds it to
	 * the specified model.
	...
	/**
	 * Constructs a <code>BnMouseClickAction</code> and subscribes it 
