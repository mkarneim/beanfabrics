...
/**
 * The <code>BnCheckBoxMenuItem</code> is a {@link JMenuItem} that can subscribe to an {@link IBooleanPM}.
 * 
...
public class BnCheckBoxMenuItem extends BooleanPMMenuItem implements ModelSubscriber {
	...
	/**
	 * Constructs a <code>BnCheckBoxMenuItem</code> and binds it
	...
	/**
	 * Constructs a <code>BnCheckBoxMenuItem</code> and subscribes it 
