...
/**
 * The <code>BnIconLabel</code> is a {@link JLabel} that can subscribe to an {@link IIconPM}.
 *
...
public class BnIconLabel extends JLabel implements View<IIconPM>, ModelSubscriber {
	...
	/**
	 * Constructs a <code>BnIconLabel</code> and binds it
	...
	/**
	 * Constructs a <code>BnIconLabel</code> and subscribes it
	...
	/**
	 * Configures this component depending on the target {@link AbstractPM}
	 * s attributes.
	 */
