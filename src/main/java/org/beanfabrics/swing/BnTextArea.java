...
/**
 * The <code>BnTextArea</code> is a {@link JTextArea} that can subscribe to an {@link ITextPM}.
 * <p>
 * For an example about using BnTextArea, please see 
 * <a href="http://www.beanfabrics.org/index.php/BnTextArea" target="parent">http://www.beanfabrics.org/index.php/BnTextArea</a>
 * </p>
...
public class BnTextArea extends TextPMTextArea implements ModelSubscriber {
	...
	/**
	 * Constructs a <code>BnTextArea</code> and binds it
