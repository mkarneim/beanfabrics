...
/**
 * The <code>BnComboBox</code> is a {@link JComboBox} that can subscribe to an {@link ITextPM}.
 * 
...
public class BnComboBox extends TextPMComboBox implements ModelSubscriber {
	...
	/**
	 * Constructs a <code>BnComboBox</code> and binds it
	...
	/**
	 * Constructs a <code>BnComboBox</code> and subscribes it 
