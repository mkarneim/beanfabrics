...
/**
 * Any class that implements this interface can subscribe to an {@link PresentationModel} 
...
public interface ModelSubscriber {
	...
	/**
	 * Sets the path. The {@link Path} is used to locate
	 * the model inside the provider.
	 *
	 * @param path
