...
public class Path implements Iterable<String> {
	 ...
	 * @param pathStr a string of path elements delimited by the dot "." character.
	 ...
	 * <pM>
	 *
	 * @param fromPosition returned path's first character's position in this path
	 * @return a new path that is a subpath of this path
	 * @throws IllegalArgumentException
	 */
	public Path getSubPath(int fromPosition) throws IllegalArgumentException {
	 ...
	 * the specified <code>fromPosition</code> and the length of the subpath
	 * is <code>length</code>.
	 *
	 * @param fromPosition returned path's first character's position in this path
	 * @param length returned path's number of characters
	 * @return a new path that is a subpath of this path
	 * @throws IllegalArgumentException thrown if <code>length < 0</code> or <code>fromPosition + length > length</code>
	 */
	public Path getSubPath(int fromPosition, int length) throws IllegalArgumentException {
		if (length < 0) {
	...
	/**
	 * Returns the length of this path. The length is the distance from the root node to the target node. Therefor the
	 * length of the identity ("this") path is 0. 
	...
	/**
	 * Returns the last element of this path or <code>null</code> if there are no elements.
	 * @return the last element of this path or <code>null</code> if there are no elements
	 */
	 ...
	 * @return <code>true</code> if the obj argument is a {@link Path} and has the equal elements as this path
	 */
	...
	// STATIC METHODS //
	/**
	 * Returns a Path object that represents a path defined by the given path string, or
	 * <code>null</code> if the path string is <code>null</code>.
	 * @return a Path object that represents a path defined by the given path string
	 */
	...
	/**
	 * Returns the canonical path string of the given path object, or <code>null</code> if the
	 * path object is <code>null</code>. 
	 * @param path
	 ...
	 * Concatenates the given strings to a path string delimited by dot '.' characters.
	 * @param strings
	 * @param alwaysPrefixWithTHIS defines that the result string has to start with the identity ("this") element.
	 * @return the concatenated strings delimited by dot characters
	 */
