...
/**
 * Beanfabrics classes use this <code>LoggerFactory</code> for producing
 * a {@link Logger} instance.
 * <p>
 * {@link Log4JLogger} is produced as default
 * if log4j is included into the classpath. Otherwise a {@link DummyLogger} is produced.
 * <p>
 * You can configure this factory to produce a custom <code>Logger</code> by
 * <ul>
 * <li>calling the method {@link #setLoggerClass(Class)}
 * <li>or by setting the system property "org.beanfabrics.log.LoggerFactory.loggerclass" to the
 * <code>Logger</code>'s classname.
 * </ul>
 *
 * @see <a href="http://www.beanfabrics.org/index.php/Logging_Example">Logging Example</a>
