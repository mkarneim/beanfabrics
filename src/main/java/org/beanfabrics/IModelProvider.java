...
public interface IModelProvider {
	 ...
	 *
	 * @param newType
	 *            the type of the presentation model to set
	 */
	 ...
	 *
	 * @param <T>
	 *            the provided presentation model type
	 ...
	 *
	 * @param pModel
	 *            the root presentation model to set
	 */
	 ...
	 *            the provided presentation model type
	 * @param path
	 *            the path which references the presentation model
