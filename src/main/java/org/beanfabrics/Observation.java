...
/**
 * The observation observes all presentation models that are
 * nodes along the specified path (using the specified presentation model object
 * as root node) and notifies any PropertyChangeListener
...
public class Observation extends AbstractBean {
	...
	/**
	 * Returns <code>true</code> if the target of this observation's path
	 * is not <code>null</code>.
	 * @return <code>true</code> if the target of this observation's path
	 * is not <code>null</code>
	 */
	...
	/**
	 * Returns the target node specified by this observation's path relative
	 * to the root node.
	 * @return the target node specified by this observation's path relative
	 * to the root node
	 */
