...
/**
 * The <code>MetadataRegistry</code> is a registry for presentation model meta data.
...
public class MetadataRegistry {
	...
	private List<PropertyInfo> createPropertyInfos(
			Class<? extends PresentationModel> modelClass, PresentationModelInfo modelInfo) {
