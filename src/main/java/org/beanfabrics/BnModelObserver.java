...
/**
 * Observer for the {@link PresentationModel} object located at the end of a specified {@link Path}
 * relatively to a {@link ModelProvider}'s root. 
 * Fires a {@link PropertyChangeEvent} (with property name "presentationModel") whenever the model
 * reference or the model properties change.    
 * The method {@link #getPresentationModel()} returns that model. 
 * 
...
public class BnModelObserver extends AbstractBean implements View<PresentationModel>, ModelSubscriber {
	...
	/**
	 * Returns whether this observer is connected to any {@link PresentationModel}
	 *
