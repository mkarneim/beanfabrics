...
/**
 * The <code>BnProgressBar</code> is a {@link JProgressBar} that can subscribe
 * to an {@link IIntegerPM}.
 * 
...
public class BnProgressBar extends JProgressBar implements View<IIntegerPM>, ModelSubscriber {
	...
	/**
	 * Constructs a <code>BnProgressBar</code> and binds it to the specified
	 * model.
	 * 
	 * @param pModel
	 *            the model
	...
	/**
	 * Constructs a <code>BnProgressBar</code> and subscribes it for the model
