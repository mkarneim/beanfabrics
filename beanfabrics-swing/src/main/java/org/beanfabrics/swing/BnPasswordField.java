...
/**
 * The <code>BnPasswordField</code> is a {@link JPasswordField} that can
...
public class BnPasswordField extends TextPMPasswordField implements ModelSubscriber {
    ...
    /**
     * Constructs a <code>BnPasswordField</code> and binds it to the specified
     * model.
     * 
    ...
    /**
     * Constructs a <code>BnPasswordField</code> and subscribes it for the model
