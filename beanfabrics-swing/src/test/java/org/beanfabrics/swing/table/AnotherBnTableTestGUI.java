...
public class AnotherBnTableTestGUI extends JFrame implements View<AnotherBnTableTestGUI.TableModel>, ModelSubscriber {
    ...
    private BnTable getBnTable() {
        if (bnTable == null) {
            ...
            bnTable.setColumns(new org.beanfabrics.swing.table.BnColumn[] { new org.beanfabrics.swing.table.BnColumn(new org.beanfabrics.Path("this.colA"), "ColA", 40, true),
                    new org.beanfabrics.swing.table.BnColumn(new org.beanfabrics.Path("this.colB"), "ColB", 100, false), new org.beanfabrics.swing.table.BnColumn(new org.beanfabrics.Path("this.colC"), "ColC", 100, false),
    ...
    private BnTable getBnTable_2() {
        if (bnTable_2 == null) {
            ...
            bnTable_2.setColumns(new org.beanfabrics.swing.table.BnColumn[] { new org.beanfabrics.swing.table.BnColumn(new org.beanfabrics.Path("this.colA"), "ColA", 40, true),
                    new org.beanfabrics.swing.table.BnColumn(new org.beanfabrics.Path("this.colB"), "ColB", 100, false), new org.beanfabrics.swing.table.BnColumn(new org.beanfabrics.Path("this.colC"), "ColC", 100, false),
                    new org.beanfabrics.swing.table.BnColumn(new org.beanfabrics.Path("this.colD"), "ColD", 100, false, new Path("this.setCurrentDate")) });
